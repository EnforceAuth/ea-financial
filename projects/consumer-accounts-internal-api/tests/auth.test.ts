...
describe('Authentication Routes', () => {
  ...
  describe('POST /auth/logout', () => {
    ...
    it.skip('should reject logout without token', async () => {
      const response = await app.handle(
        new Request('http://localhost/auth/logout', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  describe('GET /auth/verify', () => {
    ...
    it.skip('should reject malformed authorization header', async () => {
      const response = await app.handle(
        new Request('http://localhost/auth/verify', {
          method: 'GET',
          headers: {
  ...
  describe('Integration - Full Authentication Flow', () => {
    it.skip('should complete full login-verify-logout flow', async () => {
      // Step 1: Login
      const loginResponse = await app.handle(
        new Request('http://localhost/auth/login', {
          method: 'POST',
