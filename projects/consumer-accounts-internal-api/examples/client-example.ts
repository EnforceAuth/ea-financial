...
class EAFinancialAPIClient {
  ...
  async creditAccount(accountId: string, request: TransactionRequest): Promise<Transaction | null> {
    const response = await this.request<Transaction>(`/accounts/${accountId}/credit`, {
      method: 'POST',
  ...
  async debitAccount(accountId: string, request: TransactionRequest): Promise<Transaction | null> {
    const response = await this.request<Transaction>(`/accounts/${accountId}/debit`, {
      method: 'POST',
      body: JSON.stringify(request),
    });
